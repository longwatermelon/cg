...
Blossoming examples
\begin{itemize}
    \item $f(t) = t^3 \mapsto F(t_1,t_2,t_3) = t_1t_2t_3$
    \item $f(t) = t^2 \mapsto F(t_1,t_2,t_3) = (t_1t_2 + 
            t_1t_3 + t_2t_3)/3$
    \item $f(t) = t \mapsto F(t_1,t_2,t_3) = (t_1 + t_2
            + t_3)/3$
    \item $f(t) = 1 \mapsto F(t_1,t_2,t_3) = 1$
    \item $f(t) = 3t^3 - t + 1 = 3(t_1t_2t_3) - (t_1 + t_2
            + t_3)/3 + 1$
\end{itemize}
...
\mapsto \mathbb R^2$. Some ways to obtain a blossom of a cubic curve:
